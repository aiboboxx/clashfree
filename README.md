#clash节点、免费clash节点、clash订阅链接、clash免费节点、clash科学上网、clash翻墙、clash for windows、clash教程 每日更新  更新时间 2023-08-25 12:58:52  
...
proxies:
  ...
  - {name: 🇬🇧 订阅链接已失效，请到https://rss.uk.to/注册获取, server: 127.0.0.1, port: 443, type: ss, cipher: aes-128-gcm, password: 6601fb90e9b3, udp: true}
proxy-groups:
  - name: 🔰 节点选择
    type: select
    proxies:
